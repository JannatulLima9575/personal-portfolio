        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-12 md:mb-0">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              I specialize in crafting responsive and user-friendly web interfaces using React
              and Tailwind CSS. Let's collaborate to bring your ideas to life.
            </p>
            <NavLink
              to="/contact"
              className="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded shadow-lg shadow-green-500/40 transition"
            >
              Let’s get started →
            </NavLink>
          </div>
